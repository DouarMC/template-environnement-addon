...
Ce projet est un modèle d'environnement de développement d'**addons** pour **Minecraft Bedrock**. Il permet d'automatiser certaines
tâches, ou encore de valider les fichiers de configuration des addons avec des schémas JSON.

## Table des matières

- [Installation](#installation)
- [Configuration des schémas JSON](#configuration-des-schémas-json)
...
- Un éditeur de texte comme **Visual Studio Code** (VSCode) avec l'extension **JSON Schema**.
- Installer **Node.js** et **npm** pour exécuter les scripts.
- Une connexion internet pour récupérer les schémas JSON.
